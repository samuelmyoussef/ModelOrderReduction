...
pathScene = r'/home/samuelyoussef/Documents/SOFA/Plugins/ModelOrderReduction/contacts_reduction/Finger/fingerWithCollision.py'
...
listObjToAnimate = []
listObjToAnimate.append(ObjToAnimate('solverNode/finger/cable',defaultShaking,duration=-1,**{'incr': 1.0, 'incrPeriod': 10.0, 'rangeOfAction': 30.0}))
phase = []
phase.append(1)
nbIterations = 309
paramWrapper = ('/solverNode/finger', {'paramForcefield': {'prepareECSW': True, 'modesPath': '/home/samuelyoussef/Documents/SOFA/Plugins/ModelOrderReduction/contacts_reduction/Finger/reduced/data/modes.txt', 'periodSaveGIE': 6, 'nbTrainingSet': 30}, 'paramMORMapping': {'input': '@../MechanicalObject', 'modesPath': '/home/samuelyoussef/Documents/SOFA/Plugins/ModelOrderReduction/contacts_reduction/Finger/reduced/data/modes.txt'}})
phaseToSave = [0]
