...
def Reduced_myReducedModel(
                  attachedTo=None,
                  name="Reduced_myReducedModel",
    ...
    finger.addObject('MeshVTKLoader' , name = 'loader', filename = path + r'/mesh/finger.vtk', translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), scale3d = multiply(scale,[1.0, 1.0, 1.0]))
    ...
    modelCollis.addObject('MeshSTLLoader' , name = 'loader', filename = path + r'/mesh/finger.stl', translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), scale3d = multiply(scale,[1.0, 1.0, 1.0]))
...
def createScene(rootNode):
    ...
    Reduced_myReducedModel(rootNode,
                        name="Reduced_myReducedModel",
    ...
    #     Reduced_myReducedModel(rootNode,
    #                    name="Reduced_myReducedModel_blue_"+str(i),
    ...
    #     Reduced_myReducedModel(rootNode,
    #                    name="Reduced_myReducedModel_white_"+str(i),
    ...
    #     Reduced_myReducedModel(rootNode,
    #                    name="Reduced_myReducedModel_red_"+str(i),
