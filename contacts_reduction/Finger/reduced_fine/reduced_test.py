...
def Reduced_test(
    ...
    visu.addObject('MeshSTLLoader' , name = 'loader', filename = path + r'/mesh/fingerFine.stl', translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), scale3d = multiply(scale,[1.0, 1.0, 1.0]))
